...
async function init() {
  ...
  try {
    ...
    await client.query('CREATE INDEX IF NOT EXISTS idx_games_team_home ON games(team_home)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_games_team_away ON games(team_away)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_games_season ON games(season)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_player_stats_player ON player_stats(player_id)');
    await client.query('CREATE INDEX IF NOT EXISTS idx_player_stats_game ON player_stats(game_id)');
...
async function seedTeams(client) {
  ...
  for (const t of teams) {
    await client.query(`
      ...
      ON CONFLICT (id) DO UPDATE SET name=EXCLUDED.name, mlb_id=EXCLUDED.mlb_id
...
async function seedManagers(client) {
  const managers = [
    {team_id:'AZ',name:'Torey Lovullo',birth_date:'1965-07-25',season:2026},
    {team_id:'ATL',name:'Walt Weiss',birth_date:'1963-11-28',season:2026},
    {team_id:'BAL',name:'Craig Albernaz',birth_date:'1983-03-21',season:2026},
    {team_id:'BOS',name:'Alex Cora',birth_date:'1975-10-18',season:2026},
    {team_id:'CHC',name:'Craig Counsell',birth_date:'1970-08-21',season:2026},
    {team_id:'CWS',name:'Will Venable',birth_date:'1982-10-29',season:2026},
    {team_id:'CIN',name:'Terry Francona',birth_date:'1959-04-22',season:2026},
    {team_id:'CLE',name:'Stephen Vogt',birth_date:'1984-11-01',season:2026},
    {team_id:'COL',name:'Warren Schaeffer',birth_date:'1980-09-18',season:2026},
    {team_id:'DET',name:'A.J. Hinch',birth_date:'1974-05-15',season:2026},
    {team_id:'HOU',name:'Joe Espada',birth_date:'1975-08-30',season:2026},
    {team_id:'KC',name:'Matt Quatraro',birth_date:'1973-11-14',season:2026},
    {team_id:'LAA',name:'Kurt Suzuki',birth_date:'1983-10-04',season:2026},
    {team_id:'LAD',name:'Dave Roberts',birth_date:'1972-05-31',season:2026},
    {team_id:'MIA',name:'Clayton McCullough',birth_date:'1982-04-15',season:2026},
    {team_id:'MIL',name:'Pat Murphy',birth_date:'1958-11-28',season:2026},
    {team_id:'MIN',name:'Derek Shelton',birth_date:'1970-07-30',season:2026},
    {team_id:'NYM',name:'Carlos Mendoza',birth_date:'1979-11-27',season:2026},
    {team_id:'NYY',name:'Aaron Boone',birth_date:'1973-03-09',season:2026},
    {team_id:'OAK',name:'Mark Kotsay',birth_date:'1975-12-02',season:2026},
    {team_id:'PHI',name:'Rob Thomson',birth_date:'1963-08-16',season:2026},
    {team_id:'PIT',name:'Don Kelly',birth_date:'1980-02-15',season:2026},
    {team_id:'SD',name:'Craig Stammen',birth_date:'1984-03-09',season:2026},
    {team_id:'SEA',name:'Scott Servais',birth_date:'1967-06-04',season:2026},
    {team_id:'SFG',name:'Tony Vitello',birth_date:'1984-10-02',season:2026},
    {team_id:'STL',name:'Oliver Marmol',birth_date:'1986-07-02',season:2026},
    {team_id:'TB',name:'Kevin Cash',birth_date:'1977-12-06',season:2026},
    {team_id:'TEX',name:'Skip Schumaker',birth_date:'1980-02-03',season:2026},
    {team_id:'TOR',name:'John Schneider',birth_date:'1980-02-14',season:2026},
    {team_id:'WSH',name:'Blake Butera',birth_date:'1992-10-31',season:2026},
  ];
  ...
  for (const m of managers) {
    ...
    await client.query(`
      ...
      VALUES ($1,$2,$3,$4,$5)
      ON CONFLICT (team_id,season) DO UPDATE SET name=EXCLUDED.name, birth_date=EXCLUDED.birth_date, destiny_number=EXCLUDED.destiny_number
    `, [m.team_id, m.name, m.birth_date, dn, m.season]);
  }
